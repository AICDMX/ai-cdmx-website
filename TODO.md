...
- [ ] Ensure the feed structure can be reused for hackathons and similar multi-day events

### Chat Feed Summaries
- [ ] Build a summaries list (JSON-backed) for chat highlights with date, tags, and group location
- [ ] Allow rich/long text body that supports inline links to resources or threads
- [ ] Define submission flow to keep summaries easy for community managers to add

### Community Resources Directory
- [ ] Create a JSON-based resources list capturing description, primary link, and submitter info
- [ ] Allow submitter field to include free-text attribution plus optional list of related links
- [ ] Ensure every rendered resource link on the frontend carries `rel="nofollow"`
