...
<section class="section">
  <div class="container card-grid">
    <div class="card">
      <h3 data-rosey="speaker-guide-language-title">Idiomas</h3>
      <p data-rosey="speaker-guide-language-text">
        Las presentaciones pueden ser en español o inglés. Indícanos tu preferencia: organizamos traducción ligera (introducciones, preguntas) si hace falta.
      </p>
    </div>
    <div class="card">
      <h3 data-rosey="speaker-guide-stream-title">Streaming y contenido</h3>
      <p data-rosey="speaker-guide-stream-text">
        Transmitimos en vivo por YouTube y luego editamos clips cortos para redes sociales. Esto amplifica tu mensaje y te permite repasar la sesión posteriormente.
      </p>
    </div>
  </div>
</section>
